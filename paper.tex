...
\begin{abstract}
Currently, the deployment of conversational agents in the financial sector is predominately focused on handling transactional inquiries in the customer service domain. This focus is associated with the issues of marginalization of customer service employees, reinforcing the societal bias of ``low-value'' work, ethical issues of work dehumanizing, and issues of reinforcing gender and professional stereotypes. Furthermore, the deployment of these conversational agents also contributes to product differentiation based on wealth by digitizing services for general customers. In light of these problems, we advocate for leveraging conversational agents' capabilities for more inclusive design and discuss the corresponding avenues.
\end{abstract}
